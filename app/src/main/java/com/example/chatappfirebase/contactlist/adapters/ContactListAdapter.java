package com.example.chatappfirebase.contactlist.adapters;
...
import com.example.chatappfirebase.contactlist.ui.OnItemClickListener;
...
public class ContactListAdapter extends RecyclerView.Adapter<ContactListAdapter.ViewHolder> {
   ...
   public void onBindViewHolder(ViewHolder holder,int position){
       ...
       holder.textViewUser.setText(email);
   ...
   public void remove(User user){
    ...
    static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        @BindView(R.id.txtUser) TextView textViewUser;
        View view;
